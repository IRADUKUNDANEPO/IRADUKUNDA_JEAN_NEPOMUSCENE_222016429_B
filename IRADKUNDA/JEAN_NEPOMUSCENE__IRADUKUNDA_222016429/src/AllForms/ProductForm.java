...
public class ProductForm implements ActionListener{
	...
	private void setLocationandSize() {
		...
		pdescription_lb.setBounds(10,90,200,30);
		pprice_lb.setBounds(10,130,150,30);
		
		pid_txf.setBounds(250,10,190,30);
		pname_txf.setBounds(250,50,190,30);
		pdescription_txf.setBounds(250,90,190,30);
		pprice_txf.setBounds(250,130,190,30);
	...
	private void addcomponentforFrame() {
		frame.add(pid_lb);
		frame.add(pname_lb);
		frame.add(pdescription_lb);
		frame.add(pprice_lb);
		
		frame.add(pid_txf);
		frame.add(pname_txf);
		frame.add(pdescription_txf);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==insert_btn) {
			...
			pr.setPdescription(pdescription_txf.getText());
